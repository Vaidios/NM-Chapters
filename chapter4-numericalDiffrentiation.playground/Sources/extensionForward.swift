...
//let diff = NumericalDiffrentiation(x0: 5, h: 0.1, n: 5)
//let resultFor = diff.forwardDiffrence(degree: 2)
//let resultBack = diff.backwardDiffrence(degree: 2)
//let errorFor = diff.overallError(value: resultFor!)
//let errorBack = diff.overallError(value: resultBack!)
//print("[BACKWARD] is equal to \(resultBack!) and error is \(errorBack)")
